...
<head>
    ...
    <link rel="stylesheet" href="./css/taskpool.css">
    <link rel="stylesheet" href="./css/tomatoclock.css">
</head>

<body>
    <div class="bg">
        <img id="bg_img" draggable="false" width="100%" height="100%" src="./pt/bg<?php echo $sBg;?>.jpeg" alt="">
    </div>
    <div class="setting">
    ...
    <div class="nav_right_Container">
        <div class="nav_r_item">
            <svg width="24px" height="24px" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512">
                <g>
                    <path d="M14.709 15.961c-.006-1.372-.362-2.12.313-3.005.47-.576 1.79-.59 2.088.118a6.002 6.002 0 0 1 .2 2.778l-.392 4.483a3.542 3.542 0 0 1-.272 1.228.771.771 0 0 1-1.374.014 4.135 4.135 0 0 1-.272-1.26zm1.282 7.621a1.36 1.36 0 1 0 .018 2.719 1.36 1.36 0 1 0-.018-2.719zM30 7v20a3.003 3.003 0 0 1-3 3H5a3.003 3.003 0 0 1-3-3V7a3.003 3.003 0 0 1 3-3h3V3a1 1 0 0 1 2 0v1h5V3a1 1 0 0 1 2 0v1h5V3a1 1 0 0 1 2 0v1h3a3.003 3.003 0 0 1 3 3zM4 7v2h24V7a1.001 1.001 0 0 0-1-1h-3v1a1 1 0 0 1-2 0V6h-5v1a1 1 0 0 1-2 0V6h-5v1a1 1 0 0 1-2 0V6H5a1.001 1.001 0 0 0-1 1zm24 20V11H4v16a1.001 1.001 0 0 0 1 1h22a1.001 1.001 0 0 0 1-1z" fill="currentColor" opacity="1" data-original="#000000" class=""></path>
                </g>
            </svg>
        </div>
    </div>
    <div class="nofinish_Container">
        <div class="nC_title">過期任務</div>
        <div class="nC_list"></div>
    </div>
    <div class="sidebar">
        <button class="sidebar_lockbutton" type="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
                <path fill="currentColor" d="M21.407 10.779a.8.8 0 0 1-1.131 1.131l-.19-.19-4.87 4.468-1.21 3.538a1 1 0 0 1-1.653.383l-3.391-3.39-3.677 3.677a.8.8 0 0 1-1.131-1.132l3.676-3.677-3.1-3.1a1 1 0 0 1 .39-1.655l3.552-1.189 4.446-4.892-.196-.195a.799.799 0 1 1 1.131-1.131l7.354 7.354zm-2.454-.192L14.25 5.884l-4.675 5.144-3.029 1.012 6.258 6.258 1.03-3.013 5.119-4.698z">
                </path>
            </svg>
        </button>
        ...
        <ul class="sidebarUl">
            <li class="sidebarUlitem">
                <a draggable="false" href="./today.php" class="sidebar_li_a  sidebar_active">當天任務</a>
            </li>
            <li class="sidebarUlitem">
                <a draggable="false" href="./next-seven-day.php" class="sidebar_li_a">任務管理</a>
            </li>
            <li class="sidebarUlitem">
                <a draggable="false" href="./taskpool.php" class="sidebar_li_a">任務池</a>
            </li>
            <li class="sidebarUlitem">
                <a draggable="false" href="./tomotoclock.php" class="sidebar_li_a">番茄鐘</a>
            </li>
        </ul>
    </div>
    <div class="loginbody">
        <div class="today_Container">
            <div class="td_content">
                <div class="td_title">
                    <div class="td_title_line1">hello <span id="td_username"><?php echo $sName ?></span></div>
